...
namespace MusicService1.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PalylistDate")] Playlist playlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PalylistDate")] Playlist playlist)
        {
            if (id != playlist.Id)
            {
                return NotFound();
